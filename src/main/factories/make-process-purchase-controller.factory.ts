...
import { ProcessPurchaseUseCaseImpl } from "../../application/interactors/process-purchase.usecase.impl";
...
import { ProcessPurchaseControllerImpl } from "../../presentation/controllers/process-purchase.controller.impl";

export const makeProcessPurchaseController = (): ProcessPurchaseControllerImpl => {
    ...
    const useCase = new ProcessPurchaseUseCaseImpl(updateGateway, findGateway,  decrypt)
    return new ProcessPurchaseControllerImpl(useCase)
}